...
import { AbstractSyntaxTreeVisitor } from "../../../../vendor/ast-visitor-javascript/index";
import { ImplementationError } from "../../../../vendor/diagnostics/index";
...
export class ObjectVisitor extends AbstractSyntaxTreeVisitor {
    ...
    private _removeFromStack(path: NodePath<t.Node>): void {
        ...
        if (currentObject.id === this._getNodeId(path)) {
            ...
            throw new ImplementationError(
                `Unexpected object stack state: ${currentObject.id
    ...
    public MemberExpression: (path: NodePath<t.MemberExpression>) => void = (
        ...
        if (path.node.object.type === "ThisExpression") {
            ...
            if (!_object) {
                throw new ImplementationError(
                    `Unexpected object type: ${path.node.object.type
